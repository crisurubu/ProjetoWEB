...
<link href="http://localhost/ProjetoWEB/lib/css/font-awesome.min.css" rel="stylesheet"
	type="text/css">
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal" role="form"
						action="http://localhost/ProjetoWEB/util/autenticacao.jsp" method="post">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 text-center" style="top: 13px; color: #fff;">©
						ABCTreinamentos - Curso de Java para Web</div>
				</div>
			</div>
		</div>
	</footer>
